		...
		$totstar = ($ratingcount > '0')?($starcount / $ratingcount):"0";
		 ?>
					 <a href="//<?php echo $_SERVER['SERVER_NAME'].'/'.$seomerk.'/'.$seoproduct;?>.html"><div class="product-grid love-grid">
						...
						<img src="<?php echo $img['img']??$defimg ?>" height="280" alt="<?php echo $prod['name'] ?>"/>
						</div>					
						<div class="product-info">
							<div class="product-info-cust prt_name">
								<h4><?php echo $prod['name'] ?></h4>
								<input id="stars" name="stars" class="rating rating-loading" value="<?php echo round($totstar,1)?>" data-min="0" data-max="5" data-step="1" data-size="md" data-show-clear="false" data-readonly="true" data-show-caption="false"><p>( <?php echo $ratingcount ?> Votes )</p></input>							
							</div>													
						</div>
					</div></a>
		 <?php 
