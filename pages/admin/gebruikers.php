...
<div class="dropdown pull-right">
  ...
  <ul class="dropdown-menu">
  <li><a href='#' data-toggle='modal' data-target='#modal' id='<?php echo $info[id];?>' onclick='bewerk(this.id,"wachtwoord");'><i class='material-icons' title='wachtwoord' aria-hidden='true'>vpn_key</i> Wachtwoord<span class='sr-only'>Wachtwoord</span></a></li>
    <li><a href='#' data-toggle='modal' data-target='#modal' id='<?php echo $info[id];?>' onclick='bewerk(this.id,"rechten");'><i class='material-icons' title='Rechten' aria-hidden='true'>group</i> Rechten<span class='sr-only'>Rechten</span></a></li>
    <li><a href='#' data-toggle='modal' data-target='#modal' id='<?php echo $info[id];?>' onclick='bewerk(this.id,"hernoem");'><i class='material-icons' title='Naam' aria-hidden='true'>person</i> Naam<span class='sr-only'>Naam</span></a></li>
<?php if ($ban == 'n'){ ?>
	<li><a href='#' data-toggle='modal' data-target='#modal' id='<?php echo $info[id];?>' onclick='bewerk(this.id,"blokeer");'><i class='material-icons' title='Blokeer' aria-hidden='true'>lock</i> Blokeer<span class='sr-only'>Blokeer</span></a></li>
<?php }else{ ?>
	<li><a href='#' data-toggle='modal' data-target='#modal' id='<?php echo $info[id];?>' onclick='bewerk(this.id,"deblokeer");'><i class='material-icons' title='DeBlokeer' aria-hidden='true'>lock_open</i> DeBlokeer<span class='sr-only'>deBlokeer</span></a></li>
<?php } ?>
	<li><a href='#' data-toggle='modal' data-target='#modal' id='<?php echo $info[id];?>' onclick='bewerk(this.id,"verwijder");'><i class='material-icons' title='verwijder' aria-hidden='true'>cancel</i> Verwijder<span class='sr-only'>verwijder</span></a></li>
	</ul>
</div>
</td>
<?php
