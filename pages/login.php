...
<div class="container">
										...
										<div class="form-group">
											<div class="col-md-12 col-sm-12">
												<label for="user">E-mail* :</label>
													<input name="user" required="required" type="text" class="form-control" placeholder="Your Email">
											</div>
										</div>
									</div>
									<div class="row">
										<div class="form-group">
											<div class="col-md-8 col-sm-8">
												<label for="tel">Phone Number*</label>
													<input name="tel"type="text" class="form-control" placeholder="Phone number including country code">
											</div>
										</div>
									</div>		
									<div class="row">
										<div class="form-group">
											<div class="col-md-6 col-sm-6">
												<label for="pass1">Password *</label>
													<input name="pass1" required class="form-control" type="password"  placeholder="Password">
											</div>
											<div class="col-md-6 col-sm-6">
												<label for="pass2">Repeat password *</label>
													<input name="pass2" required  class="form-control"type="password" placeholder="Repeat Password">
											</div>
										</div>
									</div>
									<hr />
										...
										<div class="form-group">
											<div class="col-md-7 col-sm-7">
												<label for="adress">Adress*</label>
													<input name="adress" type="text"  required  class="form-control" placeholder="Street name">
											</div>
    ...
    <option value="ZW">Zimbabwe</option>
										...
										<div class='alert alert-danger code'>Please press the button against anti bot</div>
											...
											<input type="hidden" name="code" value="<?php echo $code ?>">
												...
												<label for="checkcode">AntiBot Code*</label>
														<input name="checkcode" id="codecheck" type="text" placeholder="Click button to generate code" readonly="readonly">
												</div>
											</div>
											</div>
										</div>
									<hr />
									<br />
									<label class="checkbox nomargin"><input class="checked-agree" required="required" type="checkbox" name="checkbox"><i></i>i agree with our <a href='#' data-toggle="modal" data-target="#modal" id="tos" onclick="tos(this.id);" aria-hidden="true" >TOS</a>.</label><br />
								</fieldset>
								<div class="row">
									<div class="col-md-12">
...
$(document).ready(function(){
    ...
    $("#code").click(function(){
       ...
       alert('Please send a email to info@<?php echo $_SERVER['SERVER_NAME']?> \nto request a pass reset');
    });
});
</script>
	 </div>
