		 ...
		 <div class="col-md-9 det">
				 <div class="single_left">
				  ...
				  <div class="single-right">
					 ...
					 <div class="id"><h4>Brand: <a href="//<?php echo $_SERVER['SERVER_NAME']."/".$sk?>.html"><?php echo $prod['merk'] ?></a></h4></div>
					  <form action="" class="sky-form">
						     <fieldset>					
							   <section>
							    <div class="id">
							     <div class="rating">
								 <h4><input id="star-rating-value" value="<?php echo round($totstar) ?>" type="number">( <?php echo $ratingcount ?> Votes )</input></h4>
						...
						<div class="clearfix"></div>						
						 <div class="prdt-cost">
							 <ul>							 
								 ...
								 <button type="button" class="btn-lg btn-primary text-center kleur" data-toggle="modal" data-target="#modal" id="<?php echo $prod['id'] ?>" onclick="shop(this.id,'toevoegen')">Buy now for &euro; <prijs id='prijs'><?php echo $prod['prijs'] ?></prijs>  
								 <?php if ($clknop['prijs'] != ""){ ?>
								 or buy for  <free id='free'><?php echo $clknop['prijs']?></free> <i class='material-icons'>3d_rotation</i>
								 <?php } ?>
								 </button>
							 </ul>
						 </div>
	 ...
	 <div class="container">
		 ...
		 <?php
					 ...
					 <a href="//<?php echo $_SERVER['SERVER_NAME'].'/'.$seomerk.'/'.$seoproduct;?>.html"><div class="product-grid love-grid">
						...
						<img src="<?php echo $img['img']??$defimg ?>" height="280" alt="<?php echo $related2['name'] ?>"/>
						</div>					
