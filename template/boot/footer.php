    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-xs-6 text-right">
                <a href='#' data-toggle="modal" data-target="#modal" id="tos" onclick="tos(this.id);"
                    aria-hidden="true">TOS</a> | <a href='#' data-toggle="modal" data-target="#modal" id="privacy"
                    onclick="tos(this.id);" aria-hidden="true">Privacy</a> | <a href='#' data-toggle="modal"
                    data-target="#modal" id="contact" onclick="tos(this.id);" aria-hidden="true">Contact</a>
            </div>
        </div>
    </div>
</div>
...
$(document).ready(function() {
    ...
    $('.error').show();
    $(".error").html(
        "<?php echo "<div class='alert alert-success fade in text-center' data-dismiss='alert' role='alert'>$error</div>"; ?>"
    );
    <?php
        }
        ?>
